...
const SollerCases = () => {
  const generalStyling = " flex flex-col gap-y-6 py-6   ";
  const classes = cn(generalStyling);

  return (
    <section className="relative  flex gap-20 pl-20">
      <div className="absolute bottom-0 right-0 z-[-1]">
        <Image src="/Ellipse 4.png" width={400} height={700} alt="eclipse" />
      </div>
      <div className="p-20  " style={{ zIndex: 1 }}>
        <Image src="/Left.png" width={750} height={600} alt="case-eclipse" />
      </div>

      <div className="pt-[169px] pb-[169px] pr-20">
