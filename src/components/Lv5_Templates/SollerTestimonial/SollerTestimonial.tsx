...
const SollerTestimonial = () => {
  return (
    <div className=" relative bg-purple-900">
      ...
      <div className="absolute bottom-20 right-0 transform rotate-x-52.93 z-0">
        <Image src="/Ellipse 3.png" width={254} height={368} alt="eclipse" />
      </div>

      <div className="relative z-10 flex items-center gap-x-40 p-20">
        <div className="flex-1">
          <SectionTitle
            variant="dark"
            label="Join other Sun harvesters"
            title="Make something awesome"
            subtitle="Dui euismod iaculis libero, aliquet vitae et elementum porttitor. Eleifend mi tristique condimentum congue fusce nunc, donec magnis commodo."
          />
        </div>
        <div>
          <SButton
...
export default SollerTestimonial;
