...
import { SButton } from "@/components/Lv2_Molecules";
import { STestimonial } from "@/components/Lv3_Cells";
import { cn } from "@/utils";

const HeroLeft = () => {
  const generalStyling = "flex flex-col gap-y-32 pt-11 px-20";
  const classes = cn(generalStyling);
  return (
    <section className={classes}>
      <div className="flex flex-col gap-6">
        <SText as="h1" size="7xl" weight="extrabold" color="blue-gray-900">
          Get the Sun to Power Your Home
        </SText>
        <SText as="p" weight="normal" size="2xl" color="blue-gray-900">
      ...
      <div>
        <STestimonial
          variant="hero"
          desc="“Viverra viverra nibh enim et aliquam, enim. Tempor, sit mus viverra orci dui consequat turpis scelerisque faucibus.”"
          imageUrl="https://doodleipsum.com/200x200/avatar-5?i=0e5f443088b010c2d0a50399ed047fba"
          name="Rwanda Melflor"
          url="zerowaste.com"
        />
      </div>
